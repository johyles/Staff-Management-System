        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-6 am-u-md-pull-6">
                    <%  %>
                    <form method="post" action="${pageContext.request.contextPath}/empModify.emp" class="am-form am-form-horizontal">
                        <input type="hidden" name="empid" readonly="readonly" value="${rempid}">
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-11">
                                <select name="deptid">
                                    <c:forEach var="dept2" items="${newdeptList}">
                                        <option value="${dept2.deptid}">${dept2.name}</option>
                                    </c:forEach>
                                </select>
                                <small>所在部门</small>
                            </div>
